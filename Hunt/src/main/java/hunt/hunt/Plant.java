...
/**
 * Class which represents the Plant objects.
 * @author Mikolaj Marmurowicz
 */
public class Plant extends javax.swing.JPanel {
    ...
    /**
     * Method to add prey using this plant.
    ...
    /**
     * Method to remove prey using this plant.
    ...
    /**
     * Creates a new object of Plant
     * @param name String that represnets the name of given plant
     * @param speedR Integer that represents the replenishing speed of given plant
     * @param capacity Integer that represents the capacity of given plant
     * @param row Integer that represents the row position of given plant 
     * @param column Integer that represents the column position of given plant
     * @param manager Manager that represents the manager of the whole game
     */
    public Plant(String name, int speedR, int capacity, int row, int column, Manager manager) {
        initComponents();
        ...
        this.png = null;
        try {
            png = ImageIO.read(new File(".\\pngs\\plant.png"));
        } catch (IOException e) {
