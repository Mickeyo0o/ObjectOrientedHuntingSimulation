...
/**
 * Class which represents the hideout objects.
 * @author Mikolaj Marmurowicz
 */
public class Hideout extends javax.swing.JPanel {
    ...
    /**
     * Method that allows to see how many tickets are currently available to a semaphore of a given object.
    ...
    /**
     * Method to see the overall capacity of the object.
     * @return The integer equal to capacity
     */
    ...
    /**
     * Method to add prey using this hideout.
    ...
    /**
     * Method to remove prey using this hideout.
    ...
    /**
     * Getter for position of hideout.
     * @return pos Position object of a given hideout
     */
    ...
    /**
     * Creates a new object of Hideout
     * @param name String that represnets the name of given hideout
     * @param speedR Integer that represents the replenishing speed of given hideout
     * @param capacity Integer that represents the capacity of given hideout
     * @param row Integer that represents the row position of given hideout 
     * @param column Integer that represents the column position of given hideout
     * @param manager Manager that represents the manager of the whole game
     */
    public Hideout(String name, int speedR, int capacity, int row, int column, Manager manager) {
        initComponents();
        ...
        this.png = null;
        try {
            png = ImageIO.read(new File(".\\pngs\\hideout2.png"));
        } catch (IOException e) {
